...
export default
    ...
    {
        mongodb_client: new mongodb.MongoClient("mongodb+srv://lab_skelbimu_portalas_user_1:<password>@cluster1.gdycmdy.mongodb.net/")
            .db("lab_skelbimu_portalas1")
            .collection("users"),
        salt: "jeJhrbAapmrDCvEm",
